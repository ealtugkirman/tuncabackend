...
async function main() {
  ...
  const lawyer1 = await prisma.lawyer.upsert({
    ...
    create: {
      ...
      practiceAreas: ['Ticaret Hukuku ve Sermaye Piyasaları', 'Birleşme ve Devralmalar'],
  ...
  const lawyer2 = await prisma.lawyer.upsert({
    ...
    create: {
      ...
      bar: 'İstanbul Barosu',
      languages: ['İngilizce'],
      practiceAreas: ['İş Hukuku', 'Ticaret Hukuku ve Sermaye Piyasaları'],
      image: '/team/ayse-yilmaz.jpg',
      isPartner: false,
      isFounder: false,
      hasPhD: false,
      certifications: [],
      bio: 'İş hukuku ve ticaret hukuku ve sermaye piyasaları alanında uzman, işçi hakları konularında deneyimli.',
    },
  })
