...
export default function EditPublicationPage({ params }: EditPublicationPageProps) {
  ...
  const onSubmit = async (data: PublicationForm) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error('Yayın güncellenemedi')
      }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Yayın Düzenle</h1>
          <p className="text-gray-600">Yayın bilgilerini güncelleyin</p>
        </div>
      </div>
